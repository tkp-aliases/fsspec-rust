...
lint-py:  ## lint python with ruff
	python -m ruff check fsspec_rust
	python -m ruff format --check fsspec_rust
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix fsspec_rust
	python -m ruff format fsspec_rust
...
test:  ## run python tests
	python -m pytest -v fsspec_rust/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v fsspec_rust/tests --cov=fsspec_rust --cov-report term-missing --cov-report xml
